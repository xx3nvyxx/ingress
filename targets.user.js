...
*/
/*
Old function S, retired on 2013/02/01 - MD5 was 7dd1bbbbae015515411974441bbf4b92
window.S = function (a, b, c, d, e) {
  c.method = b;
...
/*
Old function S, retired on 2013-02-27 - MD5 was 8f3225281c7d9928f502f2afa9cda934
...
/*
Old function S, retired on 2013-03-06 - MD5 was 378c25a3a9c859619c0d24047b8d2cbc
window.S = function(a, b, c, d, e, f) {
  c.method = b;
  var g = t(a.Hc, a, b, e), h = t(a.ed, a, b, d), i = t(a.ld, a);
  _gaq.push(["_trackEvent", "RPC", b]);
  c = $.ajax({type:"POST", url:"/rpc/" + b, dataType:"json", contentType:"application/json; charset=utf-8", data:JSON.stringify(c), Ld:function() {
    g()
  }, success:function(a) {
    CollectPortalInfo(a)
    h(a)
...
window.S = function(a, b, c, d, e, f) {
  ...
  _gaq.push(["_trackEvent", "RPC", b]);
  c = $.ajax({type:"POST", url:"/rpc/" + b, dataType:"json", contentType:"application/json; charset=utf-8", data:JSON.stringify(c), wd:function() {
    g()
  }, success:function(a) {
    CollectPortalInfo(a)
    h(a)
