...
function makePlayersTable()
{
  ...
  for (var guid in players)
  {
    ...
    if (player.name || (player.level > 5))
      playersToExport[guid] = {"name": player.name, "level": player.level, "faction": player.faction}
    player.nameField = player.name ? "<span title=" + guid + ">" + player.name + "</span>" : guid
    aaData.push(player)
  }
  ...
  var aoColumns = [
    { "sTitle": "Name",   "mData": "nameField", sWidth: '230px'},
    { "sTitle": "Level",  "mData": "level", sWidth: '60px'},
    { "sTitle": "Faction",  "mData": "faction",  "bSearchable": false, "bVisible": false}
  ]
